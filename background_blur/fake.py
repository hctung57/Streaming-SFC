...
class FakeCam:
    def __init__(self, args) -> None:
        ...
        self.webcam_path = args.webcam_path  #streaming source
        self.stream_url = f"rtmp://{self.webcam_path}/live/stream"
        ...
        self.old_mask = None
        self.real_cam = RealCam(self.stream_url,
                                self.width,
                                self.height,
                                self.fps,
                                self.codec)
