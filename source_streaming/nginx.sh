...
then 
    ...
    ffmpeg -re -stream_loop -1  -i "test.mp4" -map 0:v -r 30 -s "$resolution" -f flv "rtmp://localhost/live/stream" -map 0:a -f flv "rtmp://localhost/live/audio" -loglevel quiet -stats 2> app.log
else
